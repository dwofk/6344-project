...
fused_1x1_res = hdrvdp(mat2gray(input_img), mat2gray(fused_1x1_img), 'sRGB-display', 30);
fused_3x3_res = hdrvdp(mat2gray(input_img), mat2gray(fused_3x3_img), 'sRGB-display', 30);
mkhdr_1x1_res = hdrvdp(mat2gray(input_img), mat2gray(mkhdr_1x1_img), 'sRGB-display', 30);
mkhdr_3x3_res = hdrvdp(mat2gray(input_img), mat2gray(mkhdr_3x3_img), 'sRGB-display', 30);
